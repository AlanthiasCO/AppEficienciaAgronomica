...
class OdometroScreen extends StatefulWidget {
  ...
  const OdometroScreen({Key? key, required this.densidadeGotas}) : super(key: key);

  @override
  _OdometroScreenState createState() => _OdometroScreenState();
}
